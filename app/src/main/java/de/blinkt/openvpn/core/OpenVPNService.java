...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    public static final String DISCONNECT_VPN_NOW = "de.blinkt.openvpn.DISCONNECT_VPN_NOW";
...
//            Intent disconnectVPN = new Intent(this, DisconnectVpnNotification.class);
//            disconnectVPN.setAction(DISCONNECT_VPN_NOW);
//            PendingIntent disconnectPendingIntent = PendingIntent.getActivity(this, 0, disconnectVPN, 0);

//
//            final Intent intent = new Intent(MainActivity.ACTION_DIRECT_DISCONNECT);
//            PendingIntent disconnectPendingIntent = PendingIntent.getBroadcast(getApplicationContext(), 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
//


            Intent iAction1 = new Intent(this, MyDissconnectService.class);
            iAction1.setAction(MyDissconnectService.ACTION_DISCONNECT);
            PendingIntent disconnectPendingIntent = PendingIntent.getService(this, 0, iAction1, PendingIntent.FLAG_UPDATE_CURRENT);
